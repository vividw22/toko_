...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ URL::asset('adminlte/index3.html');}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KASIR BUCKET</span>
    </a>
  ...
  <path d="M1 2.5A1.5 1.5 0 0 1 2.5 1h3A1.5 1.5 0 0 1 7 2.5v3A1.5 1.5 0 0 1 5.5 7h-3A1.5 1.5 0 0 1 1 5.5v-3zm8 0A1.5 1.5 0 0 1 10.5 1h3A1.5 1.5 0 0 1 15 2.5v3A1.5 1.5 0 0 1 13.5 7h-3A1.5 1.5 0 0 1 9 5.5v-3zm-8 8A1.5 1.5 0 0 1 2.5 9h3A1.5 1.5 0 0 1 7 10.5v3A1.5 1.5 0 0 1 5.5 15h-3A1.5 1.5 0 0 1 1 13.5v-3zm8 0A1.5 1.5 0 0 1 10.5 9h3a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 13.5v-3z"/>
              ...
              <p>
                Menu Master
                <span class="right badge badge-succes">4</span>
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
              ...
              <li class="nav-item">
                <a href="{{ route('logout') }}" class="nav-link btn btn-danger">
                  <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-unindent" viewBox="0 0 16 16">
...
@yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="">Vi-Bucket</a>.</strong> All rights reserved.
  </footer>
