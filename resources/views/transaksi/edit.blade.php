...
<div class="card card-primary">
 ...
 <div class="card-body">
	...
	<input class="form-control" type="date" value="{{$transaksi->transaksi_tanggal}}" name="transaksi_tanggal" placeholder="Transaksi Tanggal">
	</div>
	<div class="form-group">
		<label>Transaksi Nonota</label>
	<input class="form-control" type="text" value="{{$transaksi->transaksi_nonota}}" name="transaksi_nonota" placeholder="Transaksi Nonota">
	</div>
	<div class="form-group">
