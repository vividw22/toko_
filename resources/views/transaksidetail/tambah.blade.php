...
<form method="POST" action="/supplier/store">
    ...
    <div class="form-group">
        ...
        <select name="id_barang" class="form-control">
        	...
        	<option value="{{$row->id_admin}}">{{$row->barang_nama}}</option>
        	@endforeach
        </select>
	</div>
    <div class="form-group">
		<label>Transaksi Jenis</label>
	<input class="form-control" type="text" name="transaksi_status" placeholder="Transaksi Jenis">
	</div>
    <div class="form-group">
		<label>Transaksi Harga</label>
	<input class="form-control" type="text" name="transaksi_status" placeholder="Transaksi Harga">
	</div>
    <div class="form-group">
		<label>Transaksi Jumlah</label>
	<input class="form-control" type="text" name="transaksi_status" placeholder="Transaksi Jumlah">
	</div>
    <div class="form-group">
